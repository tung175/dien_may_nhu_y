                                ...
                                >
                                    ...
                                    <template #cell(action)="row">
                                        <router-link
                                            ...
                                            ></i
                                        ></router-link>
                                        <span @click="deleteType(row.item.id)">
                                            <i
...
export default {
    ...
    methods: {
        ...
        selectAll(checked) {
            this.selected = checked ? this.types.map((item) => item.id) : [];
        ...
        selectOne(checked) {
            ...
            this.allSelected = this.selected.length === this.types.length;
        },
        deleteMutiple() {
            this.$swal({
                title: "Bạn chắc chắn muốn xóa?",
                ...
                .then(async (result) => {
                    if (result.isConfirmed) {
                        axios
                            .delete("/api/types/" + this.selected)
                            .then((response) => {
                                this.getTypes();
                            })
                            .catch((error) => {
